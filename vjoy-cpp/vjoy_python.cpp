...
#ifdef PYTHON3
#define VJOY_PY_CONST(m,v) assert(PyObject_SetAttrString(m, #v, PyLong_FromLong(v)) >= 0)
#else
#define VJOY_PY_CONST(m,v) assert(PyObject_SetAttrString(m, #v, PyInt_FromLong(v)) >= 0)
#endif
